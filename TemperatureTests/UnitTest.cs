...
public class UnitTest
{
    ...
    public void Given32FOutput0C()
    {
        ...
        [Fact]
    public void Given100FOutput37C()
    {
        Conversion conversion = new Conversion();
    ...
    [Fact]
    public void Given100COutput373K()
    {
        Conversion conversion = new Conversion();
        double expected = 373;
    ...
    [Fact]
    public void Given0KOutputMinus273C()
    {
        Conversion conversion = new Conversion();
        double expected = -273;
    ...
    [Fact]
    public void Given100KOutputMinus173C()
    {
        Conversion conversion = new Conversion();
        double expected = -173;
    ...
    [Fact]
    public void Given100FOutput310K()
    {
        Conversion conversion = new Conversion();
